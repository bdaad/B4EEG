# 241203
# chank_test10_1filter_7-5hz_survey2の下位互換
...
def communicate_and_count_test(ser, received_list_1, receive_value_1, received_list_2, receive_value_2, clock_signal_1,
                               clock_signal_2, lock):
    ...
    # higih-Qフィルタ
    a_bp_10hz = np.array(
        [1.000000000000000000000000000000, -5.986337395899265167997782555176, 14.943525948179951612360127910506,
         -19.910622476715822415371803799644, 14.934132172565124818675030837767, -5.978813517693076562409260077402,
         0.998115330047988802419922649278])
    b_bp_10hz = np.array(
        [0.000000000104796088903483945995, 0.000000000000000000000000000000, -0.000000000314388266710451837984,
         0.000000000000000000000000000000, 0.000000000314388266710451837984, 0.000000000000000000000000000000,
         -0.000000000104796088903483945995])

    # 15Hzって書いてあるけど係数は6Hzのものです.
    # 6Hz用.
    # 超高Q--7.5Hz用.(q=120).
    a_bp_15hz = np.array(
        [1.000000000000000000000000000000, -5.992046052538612777027537958929, 14.966946335049158278707182034850,
         -19.947289296362864519096547155641, 14.960665391587113504101580474526, -5.987017931980501472821742936503,
         0.998741565358762239945633609750])
    b_bp_15hz = np.array(
        [0.000000000031178759423254480474, 0.000000000000000000000000000000, -0.000000000093536278269763441422,
         0.000000000000000000000000000000, 0.000000000093536278269763441422, 0.000000000000000000000000000000,
         -0.000000000031178759423254480474])
        ...
        if ser.in_waiting > 0:  # 受信データがあるか確認
            ...
            if result:
                ...
                try:
                    ...
                    int_list_data_bp_10hz, y_prev_bp_10hz, x_prev_bp_10hz = int_list_data, y_prev_bp_10hz, x_prev_bp_10hz
                    int_list_data_bp_15hz, y_prev_bp_15hz, x_prev_bp_15hz = int_list_data, y_prev_bp_15hz, x_prev_bp_15hz
...
def func_visual(priority, flag_blink_1, flag_blink_2, lock, chank_list_1, adjust_chank_list_1, chank_list_2,
                adjust_chank_list_2, gaze_flag_1, gaze_flag_1_2, gaze_flag_2, gaze_flag_2_2):
    p = psutil.Process()
    ...
    # 画像の初期化
    look_point_image = BlinkingImage(position=(0.0, 0.6), size=(0.2, 0.2), image_path="./img_file/look_point.png",
                                     display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                     projection=projection)

    blinking_image1 = BlinkingImage(position=(-1.1, 0.0), size=(0.45, 0.45), image_path="./circle.png",
                                    display_time=None, frequency=10, refresh_rate=refresh_rate, start_on=True,
                                    projection=projection)
    blinking_image2 = BlinkingImage(position=(-0.45, 0.0), size=(0.45, 0.45), image_path="./circle.png",
                                    display_time=None, frequency=10, refresh_rate=refresh_rate, start_on=False,
                                    projection=projection)
    blinking_image3 = BlinkingImage(position=(0.45, 0.0), size=(0.45, 0.45), image_path="./circle.png",
                                    display_time=None, frequency=7.5, refresh_rate=refresh_rate, start_on=True,
                                    projection=projection)  # fre_change_word.
    blinking_image4 = BlinkingImage(position=(1.1, 0.0), size=(0.45, 0.45), image_path="./circle.png",
                                    display_time=None, frequency=7.5, refresh_rate=refresh_rate, start_on=False,
                                    projection=projection)  # fre_change_word.
    ...
    blinking_image1_off = BlinkingImage(position=(-1.0, 0.0), size=(0.45, 0.45), image_path="./circle.png",
                                        display_time=None, frequency=0.000000000001, refresh_rate=refresh_rate,
                                        start_on=False, projection=projection)

    character_image1 = BlinkingImage(position=(-1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/a_off.png",
                                     display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                     projection=projection)
    character_image1_on = BlinkingImage(position=(-1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/a_on.png",
                                        display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                        projection=projection)
    character_image1_2_on = BlinkingImage(position=(-1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/i_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                          projection=projection)
    character_image1_3_on = BlinkingImage(position=(-1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/u_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                          projection=projection)
    character_image1_4_on = BlinkingImage(position=(-1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/e_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                          projection=projection)
    character_image1_5_on = BlinkingImage(position=(-1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/o_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                          projection=projection)

    character_image2 = BlinkingImage(position=(-0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/ka_off.png",
                                     display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                     projection=projection)
    character_image2_on = BlinkingImage(position=(-0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/ka_on.png",
                                        display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                        projection=projection)
    character_image2_2_on = BlinkingImage(position=(-0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/ki_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                          projection=projection)
    character_image2_3_on = BlinkingImage(position=(-0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/ku_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                          projection=projection)
    character_image2_4_on = BlinkingImage(position=(-0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/ke_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                          projection=projection)
    character_image2_5_on = BlinkingImage(position=(-0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/ko_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                          projection=projection)

    character_image3 = BlinkingImage(position=(0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/sa_off.png",
                                     display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                     projection=projection)
    character_image3_on = BlinkingImage(position=(0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/sa_on.png",
                                        display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                        projection=projection)
    character_image3_2_on = BlinkingImage(position=(0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/si_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                          projection=projection)
    character_image3_3_on = BlinkingImage(position=(0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/su_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                          projection=projection)
    character_image3_4_on = BlinkingImage(position=(0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/se_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                          projection=projection)
    character_image3_5_on = BlinkingImage(position=(0.5, 0.2), size=(0.45, 0.45), image_path="./img_file/so_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                          projection=projection)

    character_image4 = BlinkingImage(position=(1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/ta_off.png",
                                     display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                     projection=projection)
    character_image4_on = BlinkingImage(position=(1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/ta_on.png",
                                        display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                        projection=projection)
    character_image4_2_on = BlinkingImage(position=(1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/ti_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                          projection=projection)
    character_image4_3_on = BlinkingImage(position=(1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/tu_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                          projection=projection)
    character_image4_4_on = BlinkingImage(position=(1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/te_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                          projection=projection)
    character_image4_5_on = BlinkingImage(position=(1.0, 0.2), size=(0.45, 0.45), image_path="./img_file/to_on.png",
                                          display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=False,
                                          projection=projection)

    # 入力文字の表示用.
    black_image = BlinkingImage(position=(0.0, 0.2), size=(0.7, 0.7), image_path="./black.png", display_time=None,
                                frequency=0, refresh_rate=refresh_rate, start_on=False, projection=projection)

    images = [blinking_image1, blinking_image2, blinking_image3, blinking_image4, character_image1, character_image2,
              character_image3, character_image4, look_point_image, black_image]
        ...
        if ana_counter >= ana_interval:
            ...
            if gaze_flag_1.value == True:
                if character_count == 0:
                    ...
                    4] == character_image1_2_on and character_count % 60 == 0 and character_count > 120:  # onいをonうに変更
                    images[4] = character_image1_3_on  # onいをonうに変更
                elif images[
                    4] == character_image1_3_on and character_count % 60 == 0 and character_count > 120:  # onうをonえに変更
                    images[4] = character_image1_4_on  # onうをonえに変更
                elif images[
                    4] == character_image1_4_on and character_count % 60 == 0 and character_count > 120:  # onえをonおに変更
                    images[4] = character_image1_5_on  # onえをonおに変更
                elif images[
                    4] == character_image1_5_on and character_count % 60 == 0 and character_count > 120:  # onおをonあに変更
                    images[4] = character_image1_on
                elif images[
                    4] == character_image1_on and character_count % 60 == 0 and character_count > 120:  # onあをonいに変更
            ...
            # か.
                ...
                if character_count == 0:
                    ...
                    5] == character_image2_2_on and character_count % 60 == 0 and character_count > 120:  # onきをonくに変更
                    images[5] = character_image2_3_on
                elif images[
                    5] == character_image2_3_on and character_count % 60 == 0 and character_count > 120:  # onくをonけに変更
                    images[5] = character_image2_4_on
                elif images[
                    5] == character_image2_4_on and character_count % 60 == 0 and character_count > 120:  # onけをonこに変更
                    images[5] = character_image2_5_on
                elif images[
                    5] == character_image2_5_on and character_count % 60 == 0 and character_count > 120:  # onこをonかに変更
                    images[5] = character_image2_on
                elif images[
                    5] == character_image2_on and character_count % 60 == 0 and character_count > 120:  # onかをonきに変更
                    images[5] = character_image2_2_on
                character_count += 1
            ...
            # さ.
                ...
                if character_count == 0:  # offさをonさに変更
                    ...
                    6] == character_image3_2_on and character_count % 60 == 0 and character_count > 120:  # onしをonすに変更
                    images[6] = character_image3_3_on
                elif images[
                    6] == character_image3_3_on and character_count % 60 == 0 and character_count > 120:  # onすをonせに変更
                    images[6] = character_image3_4_on
                elif images[
                    6] == character_image3_4_on and character_count % 60 == 0 and character_count > 120:  # onせをonそに変更
                    images[6] = character_image3_5_on
                elif images[
                    6] == character_image3_5_on and character_count % 60 == 0 and character_count > 120:  # onそをonさに変更
                    images[6] = character_image3_on
                elif images[
                    6] == character_image3_on and character_count % 60 == 0 and character_count > 120:  # onさをonしに変更
                    images[6] = character_image3_2_on
                character_count += 1
            ...
            # た.
                ...
                if character_count == 0:
                    ...
                    7] == character_image4_2_on and character_count % 60 == 0 and character_count > 120:  # onちをonつに変更
                    images[7] = character_image4_3_on
                elif images[
                    7] == character_image4_3_on and character_count % 60 == 0 and character_count > 120:  # onつをonてに変更
                    images[7] = character_image4_4_on
                elif images[
                    7] == character_image4_4_on and character_count % 60 == 0 and character_count > 120:  # onてをonとに変更
                    images[7] = character_image4_5_on
                elif images[
                    7] == character_image4_5_on and character_count % 60 == 0 and character_count > 120:  # onとをonたに変更
                    images[7] = character_image4_on
                elif images[
                    7] == character_image4_on and character_count % 60 == 0 and character_count > 120:  # onたをonちに変更
                    images[7] = character_image4_2_on
                character_count += 1
            ...
            if gaze_flag_1.value == False and flag_a == True:
                if character_count >= 15 and character_count < 120:
                    print("あ")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/a_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                    ...
                    print("い")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/i_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[4] == character_image1_4_on:
                    # print("え")
                    print("う")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/u_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[4] == character_image1_5_on:
                    # print("お")
                    print("え")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/e_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[4] == character_image1_on:
                    print("お")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/o_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
            ...
            # か.
                ...
                if character_count >= 15 and character_count < 120:
                    print("か")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/ka_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                    ...
                    print("き")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/ki_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[5] == character_image2_4_on:
                    # print("け")
                    print("く")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/ku_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[5] == character_image2_5_on:
                    # print("こ")
                    print("け")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/ke_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[5] == character_image2_on:
                    print("こ")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/ko_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                # images.append(input_character)
            ...
            # さ.
                ...
                if character_count >= 15 and character_count < 120:
                    print("さ")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/sa_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                    ...
                    print("し")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/si_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[6] == character_image3_4_on:
                    # print("せ")
                    print("す")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/su_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[6] == character_image3_5_on:
                    # print("そ")
                    print("せ")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/se_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[6] == character_image3_on:
                    print("そ")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/so_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                # images.append(input_character)
                images[9] = input_character  # 入力確定文字表示更新
                character_count = 0
            ...
            # た.
                ...
                if character_count >= 15 and character_count < 120:
                    print("た")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/ta_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                    ...
                    print("ち")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/ti_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[7] == character_image4_4_on:
                    # print("て")
                    print("つ")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/tu_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[7] == character_image4_5_on:
                    # print("と")
                    print("て")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/te_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                elif images[7] == character_image4_on:
                    print("と")
                    input_character = BlinkingImage(position=(0, 0.2), size=(0.7, 0.7),
                                                    image_path="./img_file/to_on.png", display_time=None, frequency=0,
                                                    refresh_rate=refresh_rate, start_on=False, projection=projection)
                # images.append(input_character)
                images[9] = input_character  # 入力確定文字表示更新
                character_count = 0
...
def func_serial(priority, com, shared_receive_list_1, receive_value_1, shared_receive_list_2, receive_value_2,
                clock_signal_1, clock_signal_2, lock):
    p = psutil.Process()
    p.nice(priority)  # psutilで優先順位を設定
    ...
    communicate_and_count_test(ser, shared_receive_list_1, receive_value_1, shared_receive_list_2, receive_value_2,
                               clock_signal_1, clock_signal_2, lock)


def func_chank(priority, receive_value, flag_blink, chank_list, clock_signal, adjust_chank_list, analysis_flag,
               chank_size, lock):
    """
...
def func_analysis2(priority, adjust_chank_list_1, analysis_flag_1, gaze_flag_1, gaze_flag_1_2, gaze_flag_2,
                   gaze_flag_2_2, adjust_chank_list_2, analysis_flag_2, lock, threshold_non_look_10hz_max,
                   threshold_non_look_10hz_min, threshold_non_look_6hz_max, threshold_non_look_6hz_min):
    p = psutil.Process()
    p.nice(priority)  # psutilで優先順位を設定
    ...
    while True:
        if analysis_flag_1.value == True:
            ...
            previous_state_10hz, previus_ave_max_10hz, previus_ave_min_10hz, down_count_10hz = phase_ana(chank_copy,
                                                                                                         count,
                                                                                                         gaze_flag_1,
                                                                                                         gaze_flag_1_2,
                                                                                                         "10Hz", 1, 20,
                                                                                                         20, 100,
                                                                                                         threshold_non_look_10hz_max,
                                                                                                         threshold_non_look_10hz_min,
                                                                                                         previous_state_10hz,
                                                                                                         previus_ave_max_10hz,
                                                                                                         previus_ave_min_10hz,
                                                                                                         down_count_10hz)
            count = count + 1
        ...
        if analysis_flag_2.value == True:
            ...
            plot_multiple_lines(chank_copy2, count2, gaze_flag_2, gaze_flag_2_2, "7-5Hz", 0, 0.133,
                                133)  # fre_change_word.
            # plot_phase_ana(chank_copy2, count2, gaze_flag_2, gaze_flag_2_2, "6Hz", 1, 20, 20, 167)    # fre_change_word.
            previous_state_6hz, previus_ave_max_6hz, previus_ave_min_6hz, down_count_6hz = phase_ana(chank_copy2,
                                                                                                     count2,
                                                                                                     gaze_flag_2,
                                                                                                     gaze_flag_2_2,
                                                                                                     "7-5Hz", 1, 20, 20,
                                                                                                     133,
                                                                                                     threshold_non_look_6hz_max,
                                                                                                     threshold_non_look_6hz_min,
                                                                                                     previous_state_6hz,
                                                                                                     previus_ave_max_6hz,
                                                                                                     previus_ave_min_6hz,
                                                                                                     down_count_6hz)  # fre_change_word.
            count2 = count2 + 1


def phase_ana(y_values, count, gaze_flag, gaze_flag2, folder, start, end, num_points, range_ms, threshold_max,
              threshold_min, previous_state, previus_ave_max, previus_ave_min, down_count):  # 位相分析
    ...
    if range_ms == 100:  # 10Hzの場合
        ...
        if len(max_value_per_row[max_value_per_row >= threshold_max.value]) >= 15 and len(min_value_per_row[
                                                                                              min_value_per_row <= threshold_min.value]) >= 15 and down_count <= down_count_threshold:
            if len(max_indices_per_row[(max_indices_per_row >= 0) & (max_indices_per_row <= 50)]) >= 11 and (
                    previous_state == 0 or previous_state == 1):  # 10~50の範囲に11個以上ある場合  : 位相非反転
                gaze_flag.value = True
                previous_state = 1
            elif len(max_indices_per_row[(max_indices_per_row >= 51) & (max_indices_per_row <= 100)]) >= 11 and (
                    previous_state == 0 or previous_state == 2):  # 51~90の範囲に11個以上ある場合  : 位相反転
        ...
        if len(max_value_per_row[max_value_per_row >= threshold_max.value]) >= 15 and len(min_value_per_row[
                                                                                              min_value_per_row <= threshold_min.value]) >= 15 and down_count <= down_count_threshold:
            if len(max_indices_per_row[(max_indices_per_row >= 0) & (max_indices_per_row <= 66)]) >= 11 and (
                    previous_state == 0 or previous_state == 3):  # 16~83の範囲に15個以上ある場合  : 位相非反転
                gaze_flag.value = True
                previous_state = 3
            elif len(max_indices_per_row[(max_indices_per_row >= 67) & (max_indices_per_row <= 133)]) >= 11 and (
                    previous_state == 0 or previous_state == 4):  # 84~151の範囲に15個以上ある場合  : 位相反転
                gaze_flag2.value = True
                previous_state = 4
            else:
                gaze_flag.value = False
    ...
    return previous_state, previus_ave_max, previus_ave_min, down_count
...
def func_visual_preparation(priority, measurement_command, lock):
    ...
    blinking_image1 = BlinkingImage(position=(0.0, 0.0), size=(0.5, 0.5), image_path="./circle.png", display_time=None,
                                    frequency=10, refresh_rate=refresh_rate, start_on=True, projection=projection)
    blinking_image1_p = BlinkingImage(position=(0.0, 0.0), size=(0.2, 0.2), image_path="./img_file/look_point.png",
                                      display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                      projection=projection)

    blinking_image2 = BlinkingImage(position=(-0.5, 0.0), size=(0.5, 0.5), image_path="./circle.png", display_time=None,
                                    frequency=10, refresh_rate=refresh_rate, start_on=False, projection=projection)

    blinking_image3 = BlinkingImage(position=(0.5, 0.0), size=(0.5, 0.5), image_path="./circle.png", display_time=None,
                                    frequency=7.5, refresh_rate=refresh_rate, start_on=True,
                                    projection=projection)  # fre_change_word.
    blinking_image3_p = BlinkingImage(position=(0.7, 0.0), size=(0.2, 0.2), image_path="./img_file/look_point.png",
                                      display_time=None, frequency=0, refresh_rate=refresh_rate, start_on=True,
                                      projection=projection)  # fre_change_word.

    blinking_image4 = BlinkingImage(position=(1.0, 0.0), size=(0.5, 0.5), image_path="./circle.png", display_time=None,
                                    frequency=7.5, refresh_rate=refresh_rate, start_on=False,
                                    projection=projection)  # fre_change_word.
    blinking_image1_off = BlinkingImage(position=(-1.0, 0.0), size=(0.45, 0.45), image_path="./circle.png",
                                        display_time=None, frequency=0.000000000001, refresh_rate=refresh_rate,
                                        start_on=False, projection=projection)
    ...
    while previous_time + 1 / n > time.time():  # 10秒間ループ
        glClear(GL_COLOR_BUFFER_BIT)  # カラーバッファをクリア
        for image in images:  # 画像を描画
            if not image.update():  # 表示時間が経過したら
                images.remove(image)  # リストから削除する理由は、リストの要素を削除すると、リストの要素が前に詰められるため、forループが正しく動作するため.本当?
...
# 1000Hzでデータ要求を送信しないで、受信も行い、データの数をカウントする関数
def communicate_and_count_test_preparation(ser, lock, measurement_command, threshold_look_10hz_max,
                                           threshold_look_6hz_max, threshold_non_look_10hz_max,
                                           threshold_non_look_6hz_max, threshold_look_10hz_min, threshold_look_6hz_min,
    ...
    # 超高Q--10Hz用.
    a_bp_high_q_10hz = np.array(
        [1.000000000000000000000000000000, -5.986337395899265167997782555176, 14.943525948179951612360127910506,
         -19.910622476715822415371803799644, 14.934132172565124818675030837767, -5.978813517693076562409260077402,
         0.998115330047988802419922649278])
    b_bp_high_q_10hz = np.array(
        [0.000000000104796088903483945995, 0.000000000000000000000000000000, -0.000000000314388266710451837984,
         0.000000000000000000000000000000, 0.000000000314388266710451837984, 0.000000000000000000000000000000,
         -0.000000000104796088903483945995])

    # 超高Q--7.5Hz用.(q=120).
    a_bp_high_q_6hz = np.array(
        [1.000000000000000000000000000000, -5.992046052538612777027537958929, 14.966946335049158278707182034850,
         -19.947289296362864519096547155641, 14.960665391587113504101580474526, -5.987017931980501472821742936503,
         0.998741565358762239945633609750])
    b_bp_high_q_6hz = np.array(
        [0.000000000031178759423254480474, 0.000000000000000000000000000000, -0.000000000093536278269763441422,
         0.000000000000000000000000000000, 0.000000000093536278269763441422, 0.000000000000000000000000000000,
         -0.000000000031178759423254480474])
        ...
        if ser.in_waiting > 0:  # 受信データがあるか確認
            ...
            if result:
                ...
                if measurement_command.value == 2:  # 10Hz計測開始命令
                    ...
                    maxima_indices_topn, maxima_values_topn = find_local_maxima(np.array(store_list_look_10hz)[:, 0],
                                                                                top_n=20)  # 極大値top50を求める.
                    minima_indices_topn, minima_values_topn = find_local_minima(np.array(store_list_look_10hz)[:, 0],
                                                                                top_n=20)  # 極小値top50を求める.
                    with lock:
                    ...
                    maxima_indices_topn, maxima_values_topn = find_local_maxima(np.array(store_list_look_6hz)[:, 0],
                                                                                top_n=30)  # 極大値top50を求める.
                    minima_indices_topn, minima_values_topn = find_local_minima(np.array(store_list_look_6hz)[:, 0],
                                                                                top_n=30)  # 極小値top50を求める.
                    with lock:
                    ...
                    maxima_indices_topn, maxima_values_topn = find_local_maxima(
                        np.array(store_list_non_look_10hz)[:, 0], top_n=100)  # 極大値top50を求める. 60秒-600個
                    minima_indices_topn, minima_values_topn = find_local_minima(
                        np.array(store_list_non_look_10hz)[:, 0], top_n=100)  # 極小値top50を求める.
                    with lock:
                        threshold_non_look_10hz_max.value = np.mean(maxima_values_topn)
                        threshold_non_look_10hz_min.value = np.mean(minima_values_topn)

                    maxima_indices_topn, maxima_values_topn = find_local_maxima(np.array(store_list_non_look_6hz)[:, 0],
                                                                                top_n=75)  # 極大値top50を求める. 60秒-450個
                    minima_indices_topn, minima_values_topn = find_local_minima(np.array(store_list_non_look_6hz)[:, 0],
                                                                                top_n=75)  # 極小値top50を求める.
                    with lock:
...
def func_serial_preparation(priority, com, lock, measurement_command, threshold_look_10hz_max, threshold_look_6hz_max,
                            threshold_non_look_10hz_max, threshold_non_look_6hz_max, threshold_look_10hz_min,
                            threshold_look_6hz_min, threshold_non_look_10hz_min, threshold_non_look_6hz_min):
    p = psutil.Process()
    p.nice(priority)  # psutilで優先順位を設定
    print(f"Process (func_serial) started with priority {priority}")
    while True:
        try:
            ...
            print("COMポートが開けませんでした。再度入力してください。")
    communicate_and_count_test_preparation(ser, lock, measurement_command, threshold_look_10hz_max,
                                           threshold_look_6hz_max, threshold_non_look_10hz_max,
                                           threshold_non_look_6hz_max, threshold_look_10hz_min, threshold_look_6hz_min,
                                           threshold_non_look_10hz_min, threshold_non_look_6hz_min)
...
def main():
    ...
    if setup_specimen == True:
        process0_1 = multiprocessing.Process(target=func_serial_preparation, args=(
        priority1, com, lock, measurement_command, threshold_look_10hz_max, threshold_look_6hz_max,
        threshold_non_look_10hz_max, threshold_non_look_6hz_max, threshold_look_10hz_min, threshold_look_6hz_min,
        threshold_non_look_10hz_min, threshold_non_look_6hz_min))
        process0_2 = multiprocessing.Process(target=func_visual_preparation,
                                             args=(priority1, measurement_command, lock))
        # プロセスの開始
        process0_1.start()
        process0_2.start()
        # プロセスの終了を待つ
        ...
        # 配列に値を格納する.
        thresholds = [threshold_look_10hz_max.value, threshold_look_10hz_min.value, threshold_look_6hz_max.value,
                      threshold_look_6hz_min.value, threshold_non_look_10hz_max.value,
                      threshold_non_look_10hz_min.value, threshold_non_look_6hz_max.value,
                      threshold_non_look_6hz_min.value]  # ファイルに保存する.
    ...
    # process1 = multiprocessing.Process(target=func_serial, args=(
    # priority1, com, shared_receive_list_1, receive_value_1, shared_receive_list_2, receive_value_2, clock_signal_1,
    # clock_signal_2, lock))
    #
    # process2 = multiprocessing.Process(target=func_chank, args=(
    # priority2, receive_value_1, flag_blink_1, chank_list_1, clock_signal_1, adjust_chank_list_1, analysis_flag_1, 100,
    # lock))  # 10Hz: 1000data / 10Hz = 100
    ...
    # process3 = multiprocessing.Process(target=func_chank, args=(
    # priority3, receive_value_2, flag_blink_2, chank_list_2, clock_signal_2, adjust_chank_list_2, analysis_flag_2, 133,
    # lock))  # 7.5Hz: 1000data / 7.5Hz = 133.3333 = 133         # fre_change_word.
    #
    # process4 = multiprocessing.Process(target=func_visual, args=(
    # priority4, flag_blink_1, flag_blink_2, lock, chank_list_1, adjust_chank_list_1, chank_list_2, adjust_chank_list_2,
    # gaze_flag_1, gaze_flag_1_2, gaze_flag_2, gaze_flag_2_2))
    #
    # process5 = multiprocessing.Process(target=func_analysis2, args=(
    # priority5, adjust_chank_list_1, analysis_flag_1, gaze_flag_1, gaze_flag_1_2, gaze_flag_2, gaze_flag_2_2,
    # adjust_chank_list_2, analysis_flag_2, lock, threshold_non_look_10hz_max, threshold_non_look_10hz_min,
    # threshold_non_look_6hz_max, threshold_non_look_6hz_min))
    #
    # # プロセスの開始
    # process1.start()
    # process2.start()
