...
def communicate_and_count_test(ser , received_list, receive_value, clock_signal_1, clock_signal_2, lock):
    ...
    a_bp = np.array([0.000039222815344601606540007877,  0.000000000000000000000000000000,-0.000078445630689203213080015753,  0.000000000000000000000000000000,0.000039222815344601606540007877])
    b_bp = np.array([1.000000000000000000000000000000, -3.974428294786210180689067783533,5.931305335419762236881524586352, -3.939226621802428329743861468160,0.982364711720531635918973734078])
