        ...
        if ser.in_waiting > 0:  # 受信データがあるか確認
            ...
            if result:
                ...
                with lock:  # ロックを使って排他制御
                    ...
                    receive_value_2[:] = last_data_7_5hz
...
def func_visual(priority, flag_blink_1, flag_blink_2, lock, chank_list_1, adjust_chank_list_1, chank_list_2, adjust_chank_list_2, gaze_flag_1, gaze_flag_1_2, gaze_flag_2, gaze_flag_2_2, chank_list_1_2, adjust_chank_list_1_2, chank_list_2_2, adjust_chank_list_2_2):
    ...
    projection_location = glGetUniformLocation(shader_program, "projection") # uniformの場所を取得
...
# /**************************/
        ...
        if input_character != black_image:
...
def main():
    ...
    if setup_specimen == True:
        ...
        threshold_non_look_6hz_max.value = 17000
        threshold_non_look_10hz_min.value = -22000
        threshold_non_look_6hz_min.value = -17000
