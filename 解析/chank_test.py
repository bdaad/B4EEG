...
def funk_chunk():
    ...
    count_cunk = 4
    while True:
        # print("len" + str(len(received_data)))
        # 最初の1000データは不安定なので処理に使用しない.
        if len(received_data) < count_cunk * 1000:
            pass
        elif len(received_data) >= count_cunk * 1000:
            chunk_data1 = received_data[count_cunk * 1000 - 3000 + 1: count_cunk * 1000 - 2000]#配列の1001番目から2000番目までを取り出す.
            chunk_data2 = received_data[count_cunk * 1000 - 2000 + 1: count_cunk * 1000 - 1000]#配列の2001番目から3000番目までを取り出す.
            chunk_data3 = received_data[count_cunk * 1000 - 1000 + 1: count_cunk * 1000]#配列の3001番目から4000番目までを取り出す

            chunk_data_2d_store.append(chunk_data1 + chunk_data2 + chunk_data3)
            print(count_cunk)
            count_cunk += 1
